...
public class AlarmEntity implements Parcelable {
	 ...
	 * 一天
	 */
	public final static int				TIME_OF_ONE_DAY				= 86400000;
	
	/**
	 * 一周
	 */
	public final static int				TIME_OF_ONE_WEEK			= 604800000;
	 ...
	 * 每月重复的周期闹钟
	 */
	public static final String			TYPE_REPEAT_EVERY_MONTH		= "TYPE_REPEAT_EVERY_MONTH";	// 每周几重复
	...
	public int getTimeSpan() {
		if (timeSpan == 0) {
			timeSpan = TIME_OF_ONE_DAY; // 默认为1天
		}
		return timeSpan;
	}
